...
train_data = pd.read_csv('C:\\Users\\jakyd\\Desktop\\progetto_AI\\dataset\\emnist-letters-train.csv', header=None)
test_data = pd.read_csv('C:\\Users\\jakyd\\Desktop\\progetto_AI\\dataset\\emnist-letters-test.csv', header=None)
